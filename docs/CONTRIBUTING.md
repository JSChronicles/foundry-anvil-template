...
See our [Support Guide](https://github.com/JSChronicles/foundry-anvil-template/blob/main/docs/SUPPORT.md). In short, GitHub issues are not the appropriate place to debug your specific project, but should be reserved for filing bugs and feature requests.
...
Review our [Security Policy](https://github.com/JSChronicles/foundry-anvil-template/blob/main/docs/SECURITY.md). **Do not** file a public issue for security vulnerabilities.
...
- **Review the documentation and [Support Guide](https://github.com/JSChronicles/foundry-anvil-template/blob/main/docs/SUPPORT.md)** before opening a new issue.
